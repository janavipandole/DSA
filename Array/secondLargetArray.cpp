...
int main()
{
    ...
    cout << "second Largest Brute : " << secondLargestBrute(nums) << endl;
    cout << "second Largest Better : " << secondLargestBetter(nums) << endl;
    cout << "second Largest optimal : " << secondLargestOptimal(nums) << endl;
    cout << "second Smallest  : " << endl;
    cout << "second Smallest Brute " << secondSmallestBrute(nums) << endl;
    cout << "second Largest Better : " << secondSmallestBetter(nums) << endl;
    cout << "second Largest optimal : " << secondSmallestOptimal(nums) << endl;
    return 0;
}